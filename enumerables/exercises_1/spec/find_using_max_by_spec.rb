RSpec.describe 'max_by' do
  # max_by
  # max_by(obj)
  # max_by returns an array of maximum elements which meets a criterion
  ...
  it 'most programmers' do
    ...
    most_programmers = programmers.max_by do |language, programmer|
      programmer.size
    end
  ...
  it 'fewest programmers' do
    ...
    fewest_programmers = programmers.min_by do |language, programmer|
      programmer.size
    end
