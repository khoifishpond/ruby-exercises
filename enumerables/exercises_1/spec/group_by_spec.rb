...
# group_by
# group_by { |obj| block }
# group_by groups the collection by result of the block. returns a hash where
# the keys are evaluated result from the block and values are arrays of elements
