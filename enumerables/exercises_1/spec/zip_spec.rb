...
# zip(arg, ...)
# zip takes one element from enum and merges corrsponding elements from each args
# generates a sequence of n-element arrays, where n is one more than the count of
# arguments
